		...
		<div>
			...
			<div class="w3layouts_gallery_grids">	
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image01.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image02.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image03.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image04.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image05.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image06.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image07.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="<?php echo base_url();  ?>assets/images/image07.jpg" alt=" " class="img-responsive">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text"><h3>RecCorian</h3></div>
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image17.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
				...
				<div class="col-md-4 w3layouts_gallery_grid">
					<a href="images/image09.jpg" class="lsb-preview" data-lsb-group="header">
						<div class="w3layouts_news_grid">
							<img src="<?php echo base_url();  ?>assets/images/image09.jpg" alt=" " class="img-responsive">
							<div class="w3layouts_news_grid_pos">
								<div class="wthree_text"><h3>RecCorian</h3></div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 to-animate">
					...
					<ul class="contact-info">
						<li><a href="#" data-nav-section="home"><i class="icon-arrow-right2" aria-hidden="true"></i>Home</a></li>
						<li><a href="#" data-nav-section="about"><i class="icon-arrow-right2" aria-hidden="true"></i>About</a></li>
						<li><a href="#" data-nav-section="gallery"><i class="icon-arrow-right2" aria-hidden="true"></i>Gallery</a></li>
						<li><a href="#" data-nav-section="team"><i class="icon-arrow-right2" aria-hidden="true"></i>Contact Us</a></li>
						<li><a href="#" data-nav-section="contact"><i class="icon-arrow-right2" aria-hidden="true"></i>Contact Us</a></li>
