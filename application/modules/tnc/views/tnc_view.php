...
<section class="history" id="page-about">
	...
	<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use OriseChina's website 
	...
	<p>You must not:</p>
	<ol>
		<li>Republish material from http://www.OriseChina.com</li>
		<li>Sell, rent or sub-license material from http://www.OriseChina.com</li>
	...
	the visibility associated with the hyperlink outweighs the absence of company name; and (d) where the
	...
	you must notify us by sending an e-mail to <a href="mailto:info@orisechina.com" title="send an email to info@orisechina.com">info@orisechina.com</a>.
