<!-- ========================  Home Slider ======================== -->
    ...
    background-position: center center;">
        ...
        <section class="info-icons info-icons-frontpage">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-3">
                        <figure>
                        	<a href="<?php echo base_url();  ?>our_services">
                            <figcaption>
                            	<span>
        ...
        <section class="blog" id="page-product">
            ...
            <div class="container">
                ...
                <?php $a=1;
                 $cat_items = array();
                 foreach ($cat_item_counts as $cat_count) {
                     $cat_items[$cat_count->category] = $cat_count->prod_count;
                 }
                             ...
                             <a href="<?php echo base_url();  ?>category_page/view_category/<?php echo $category->id;?>">
                              <div class="image lazyload" data-bgset="<?php echo base_url();  ?>upload/cats/<?php echo $category->image; ?>">
                                ...
                                <div class="entry entry-table">
                                    ...
                                    <div class="title">
                                    	<?php
                                    	$item_count = (isset($cat_items[$category->category])) ? $cat_items[$category->category] : 0;
                                    	?>
                                        <h2 class="h5"> <?php echo $category->category . '<span style="float:right" class="label label-info"> ' . $item_count . '</span>'; ?></h2>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input type="text" value="" class="form-control" placeholder="Your name" required="required" name="name">
                                                            </div>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input type="email" value="" class="form-control" placeholder="Your email" required="required" name="email">
                                                            </div>
                                                        </div>
